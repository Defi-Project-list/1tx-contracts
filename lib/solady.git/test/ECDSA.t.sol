...
contract ECDSATest is SoladyTest {
    ...
    function testBytesToEthSignedMessageHash() public {
        _testBytesToEthSignedMessageHash(999_999);
        _testBytesToEthSignedMessageHash(135_790);
        _testBytesToEthSignedMessageHash(99_999);
        _testBytesToEthSignedMessageHash(88_888);
    ...
    function testBytesToEthSignedMessageHashExceedsMaxLengthReverts() public {
        vm.expectRevert();
        _testBytesToEthSignedMessageHash(999_999 + 1);
    }
