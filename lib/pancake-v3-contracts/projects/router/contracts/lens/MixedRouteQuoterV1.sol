...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, IPancakeV3SwapCallback, PeripheryImmutableState {
        ...
        returns (uint256 amountOut)
    {
        (uint256 reserveIn, uint256 reserveOut) =
            SmartRouterHelper.getReserves(factoryV2, params.tokenIn, params.tokenOut);
        ...
        returns (uint256 amountOut)
    {
        (uint256 i, uint256 j, address swapContract) =
            SmartRouterHelper.getStableInfo(factoryStable, params.tokenIn, params.tokenOut, params.flag);
