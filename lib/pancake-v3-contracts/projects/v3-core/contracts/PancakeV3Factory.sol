...
contract PancakeV3Factory is IPancakeV3Factory {
    ...
    constructor(address _poolDeployer) {
        ...
        feeAmountTickSpacingExtraInfo[10_000] = TickSpacingExtraInfo({ whitelistRequested: false, enabled: true });
        emit FeeAmountEnabled(10_000, 200);
        emit FeeAmountExtraInfoUpdated(10_000, false, true);
    }
    ...
    function setFeeAmountExtraInfo(uint24 fee, bool whitelistRequested, bool enabled) public override onlyOwner {
        ...
        feeAmountTickSpacingExtraInfo[fee] =
            TickSpacingExtraInfo({ whitelistRequested: whitelistRequested, enabled: enabled });
