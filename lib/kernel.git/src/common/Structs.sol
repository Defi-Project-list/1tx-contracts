...
struct SessionData {
    ...
    address paymaster; // address(0) means accept userOp without paymaster, address(1) means reject userOp with
        // paymaster, other address means accept userOp with paymaster with the address
    uint256 nonce;
}
