...
contract KillSwitchValidator is IKernelValidator {
    ...
    {
        KillSwitchValidatorStorage storage validatorStorage = killSwitchValidatorStorage[msg.sender]; // should use
            // msg.sender to prevent others from changing storage
