    ...
    function forceSafeTransferETH(address to, uint256 amount, uint256 gasStipend) internal {
        ...
        assembly {
            ...
            if iszero(call(gasStipend, to, amount, gas(), 0x00, gas(), 0x00)) {
                ...
                if iszero(create(amount, 0x0b, 0x16)) { returndatacopy(gas(), returndatasize(), shr(20, gas())) } // For
                    // gas estimation.
            }
        }
    }
    ...
    function forceSafeTransferAllETH(address to, uint256 gasStipend) internal {
        ...
        assembly {
            if iszero(call(gasStipend, to, selfbalance(), gas(), 0x00, gas(), 0x00)) {
                ...
                mstore8(0x0b, 0x73) // Opcode `PUSH20`.
                mstore8(0x20, 0xff) // Opcode `SELFDESTRUCT`.
                if iszero(create(selfbalance(), 0x0b, 0x16)) { returndatacopy(gas(), returndatasize(), shr(20, gas())) } // For
                    // gas estimation.
            }
        }
    }
