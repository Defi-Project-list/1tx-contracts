...
contract DateTimeLibTest is SoladyTest {
    ...
    function testDateTimeMaxSupported() public {
        ...
        assertEq(
            DateTimeLib.dateToTimestamp(DateTimeLib.MAX_SUPPORTED_YEAR, 12, 31) + 86_400 - 1,
    ...
    function testDateToEpochDay() public {
        ...
        assertEq(DateTimeLib.dateToEpochDay(2000, 3, 1), 11_017);
        assertEq(DateTimeLib.dateToEpochDay(2355, 12, 31), 140_982);
        assertEq(DateTimeLib.dateToEpochDay(99_999, 12, 31), 35_804_721);
        assertEq(DateTimeLib.dateToEpochDay(100_000, 12, 31), 35_805_087);
        assertEq(DateTimeLib.dateToEpochDay(604_800, 2, 29), 220_179_195);
        assertEq(DateTimeLib.dateToEpochDay(1_667_347_200, 2, 29), 608_985_340_227);
        assertEq(DateTimeLib.dateToEpochDay(1_667_952_000, 2, 29), 609_206_238_891);
    }
    ...
    function testDaysToDate() public {
        ...
        (d.year, d.month, d.day) = DateTimeLib.epochDayToDate(10_987);
        assertTrue(d.year == 2000 && d.month == 1 && d.day == 31);
        (d.year, d.month, d.day) = DateTimeLib.epochDayToDate(18_321);
        assertTrue(d.year == 2020 && d.month == 2 && d.day == 29);
        (d.year, d.month, d.day) = DateTimeLib.epochDayToDate(156_468);
        assertTrue(d.year == 2398 && d.month == 5 && d.day == 25);
        (d.year, d.month, d.day) = DateTimeLib.epochDayToDate(35_805_087);
        assertTrue(d.year == 100_000 && d.month == 12 && d.day == 31);
    }
    ...
    function testDateToAndFroTimestamp() public {
        unchecked {
            for (uint256 i; i < 256; ++i) {
                ...
                assertEq(timestamp, DateTimeLib.dateToEpochDay(year, month, day) * 86_400);
    ...
    function testIsLeapYear() public {
        ...
        assertTrue(DateTimeLib.isLeapYear(10_032));
        assertTrue(DateTimeLib.isLeapYear(10_124));
        assertTrue(DateTimeLib.isLeapYear(10_296));
        assertTrue(DateTimeLib.isLeapYear(10_400));
        assertTrue(DateTimeLib.isLeapYear(10_916));
    }
    ...
    function testWeekday() public {
        ...
        assertEq(DateTimeLib.weekday(86_400), 5);
        assertEq(DateTimeLib.weekday(86_401), 5);
        assertEq(DateTimeLib.weekday(172_800), 6);
        assertEq(DateTimeLib.weekday(259_200), 7);
        assertEq(DateTimeLib.weekday(345_600), 1);
        assertEq(DateTimeLib.weekday(432_000), 2);
        assertEq(DateTimeLib.weekday(518_400), 3);
    }
    ...
    function testNthWeekdayInMonthOfYearTimestamp() public {
        ...
        wd = DateTimeLib.MON;
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 11, 1, wd), 1_667_779_200);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 11, 2, wd), 1_668_384_000);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 11, 3, wd), 1_668_988_800);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 11, 4, wd), 1_669_593_600);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 11, 5, wd), 0);

        // 1st... 5th Wednesday in November 2022.
        wd = DateTimeLib.WED;
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 11, 1, wd), 1_667_347_200);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 11, 2, wd), 1_667_952_000);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 11, 3, wd), 1_668_556_800);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 11, 4, wd), 1_669_161_600);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 11, 5, wd), 1_669_766_400);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 11, 6, wd), 0);

        // 1st... 5th Friday in December 2022.
        wd = DateTimeLib.FRI;
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 12, 1, wd), 1_669_939_200);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 12, 2, wd), 1_670_544_000);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 12, 3, wd), 1_671_148_800);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 12, 4, wd), 1_671_753_600);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 12, 5, wd), 1_672_358_400);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2022, 12, 6, wd), 0);

        // 1st... 5th Sunday in January 2023.
        wd = DateTimeLib.SUN;
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2023, 1, 1, wd), 1_672_531_200);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2023, 1, 2, wd), 1_673_136_000);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2023, 1, 3, wd), 1_673_740_800);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2023, 1, 4, wd), 1_674_345_600);
        assertEq(DateTimeLib.nthWeekdayInMonthOfYearTimestamp(2023, 1, 5, wd), 1_674_950_400);
    ...
    function testMondayTimestamp() public {
        ...
        assertEq(DateTimeLib.mondayTimestamp(86_400), 0);
        // Saturday 03 January 1970 -> 172800
        assertEq(DateTimeLib.mondayTimestamp(172_800), 0);
        // Sunday 04 January 1970 -> 259200
        assertEq(DateTimeLib.mondayTimestamp(259_200), 0);
        // Monday 05 January 19700 -> 345600
        assertEq(DateTimeLib.mondayTimestamp(345_600), 345_600);
        // Monday 07 November 2022 -> 1667779200
        assertEq(DateTimeLib.mondayTimestamp(1_667_779_200), 1_667_779_200);
        // Sunday 06 November 2022 -> 1667692800
        assertEq(DateTimeLib.mondayTimestamp(1_667_692_800), 1_667_174_400);
        // Saturday 05 November 2022 -> 1667606400
        assertEq(DateTimeLib.mondayTimestamp(1_667_606_400), 1_667_174_400);
        // Friday 04 November 2022 -> 1667520000
        assertEq(DateTimeLib.mondayTimestamp(1_667_520_000), 1_667_174_400);
        // Thursday 03 November 2022 -> 1667433600
        assertEq(DateTimeLib.mondayTimestamp(1_667_433_600), 1_667_174_400);
        // Wednesday 02 November 2022 -> 1667347200
        assertEq(DateTimeLib.mondayTimestamp(1_667_347_200), 1_667_174_400);
        // Tuesday 01 November 2022 -> 1667260800
        assertEq(DateTimeLib.mondayTimestamp(1_667_260_800), 1_667_174_400);
        // Monday 01 November 2022 -> 1667260800
        assertEq(DateTimeLib.mondayTimestamp(1_667_174_400), 1_667_174_400);
    }

    function testMondayTimestamp(uint256 timestamp) public {
        uint256 day = timestamp / 86_400;
        uint256 weekday = (day + 3) % 7;
        assertEq(DateTimeLib.mondayTimestamp(timestamp), timestamp > 345_599 ? (day - weekday) * 86_400 : 0);
    }
    ...
    function testAddSubDiffYears(uint256 timestamp, uint256 numYears) public {
        uint256 maxNumYears = 1_000_000;
        numYears = _bound(numYears, 0, maxNumYears);
        timestamp = _bound(timestamp, 0, DateTimeLib.MAX_SUPPORTED_TIMESTAMP - maxNumYears * 366 * 86_400);
    ...
    function testAddSubDiffMonths(uint256 timestamp, uint256 numMonths) public {
        uint256 maxNumMonths = 1_000_000;
        numMonths = _bound(numMonths, 0, maxNumMonths);
        timestamp = _bound(timestamp, 0, DateTimeLib.MAX_SUPPORTED_TIMESTAMP - maxNumMonths * 32 * 86_400);
    ...
    function testAddSubDiffDays(uint256 timestamp, uint256 numDays) public {
        uint256 maxNumDays = 100_000_000;
        numDays = _bound(numDays, 0, maxNumDays);
        timestamp = _bound(timestamp, 0, DateTimeLib.MAX_SUPPORTED_TIMESTAMP - maxNumDays * 86_400);
    ...
    function testAddSubDiffHours(uint256 timestamp, uint256 numHours) public {
        uint256 maxNumHours = 10_000_000_000;
    ...
    function testAddSubDiffMinutes(uint256 timestamp, uint256 numMinutes) public {
        uint256 maxNumMinutes = 10_000_000_000;
    ...
    function testAddSubDiffSeconds(uint256 timestamp, uint256 numSeconds) public {
        uint256 maxNumSeconds = 1_000_000_000_000;
    ...
    function _dateToEpochDayOriginal2(uint256 year, uint256 month, uint256 day) internal pure returns (uint256 _days) {
        unchecked {
            ...
            int256 __days = _day - 32_075 + ((1461 * (_year + 4800 + _m)) / 4) + ((367 * (_month - 2 - _m * 12)) / 12)
                - ((3 * ((_year + 4900 + _m) / 100)) / 4) - 2_440_588;
        ...
        returns (uint256 year, uint256 month, uint256 day)
    {
        unchecked {
            timestamp += 719_468;
            uint256 era = timestamp / 146_097;
            uint256 doe = timestamp - era * 146_097;
