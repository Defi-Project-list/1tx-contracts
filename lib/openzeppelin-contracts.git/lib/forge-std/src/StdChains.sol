...
abstract contract StdChains {
    ...
    function initialize() private {
        ...
        setChainWithDefaultRpcUrl("anvil", Chain("Anvil", 31_337, "http://127.0.0.1:8545"));
        ...
        setChainWithDefaultRpcUrl(
            "sepolia", Chain("Sepolia", 11_155_111, "https://sepolia.infura.io/v3/6770454bc6ea42c58aac12978531b93f")
        );
        ...
        setChainWithDefaultRpcUrl("arbitrum_one", Chain("Arbitrum One", 42_161, "https://arb1.arbitrum.io/rpc"));
        setChainWithDefaultRpcUrl(
            "arbitrum_one_goerli", Chain("Arbitrum One Goerli", 421_613, "https://goerli-rollup.arbitrum.io/rpc")
        );
        setChainWithDefaultRpcUrl("arbitrum_nova", Chain("Arbitrum Nova", 42_170, "https://nova.arbitrum.io/rpc"));
        setChainWithDefaultRpcUrl("polygon", Chain("Polygon", 137, "https://polygon-rpc.com"));
        setChainWithDefaultRpcUrl(
            "polygon_mumbai", Chain("Polygon Mumbai", 80_001, "https://rpc-mumbai.maticvigil.com")
        );
        setChainWithDefaultRpcUrl("avalanche", Chain("Avalanche", 43_114, "https://api.avax.network/ext/bc/C/rpc"));
        setChainWithDefaultRpcUrl(
            "avalanche_fuji", Chain("Avalanche Fuji", 43_113, "https://api.avax-test.network/ext/bc/C/rpc")
        );
